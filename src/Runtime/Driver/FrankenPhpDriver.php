...
final class FrankenPhpDriver implements HostDriverInterface
{
    /** @var Closure(): HttpRequest */
    private readonly Closure $requestFactory;

    /** @var Closure(callable(): void): bool|null */
    private readonly ?Closure $workerRequestHandler;
    ...
    public function __construct(
        private readonly FrankenPhpOptions $options,
    ...
    private static function nativeWorkerRequestHandler(): ?Closure
    {
        ...
        $handler = Closure::fromCallable('frankenphp_handle_request');

...
final readonly class RuntimeMetricsSnapshot
{
    ...
    public function __construct(
        ...
        public int $queuedBytesCurrent = 0,
        public int $queuedBytesPeak = 0,
        public int $queuedBytesLimit = 0,
    ...
    public static function fromArray(array $data): ?self
    {
        ...
        return new self(
            ...
            queuedBytesCurrent: self::integer($data, 'queued_bytes_current'),
            queuedBytesPeak: self::integer($data, 'queued_bytes_peak'),
            queuedBytesLimit: self::integer($data, 'queued_bytes_limit'),
    ...
    public function toArray(): array
    {
        return [
            ...
            'queued_bytes_current' => $this->queuedBytesCurrent,
            'queued_bytes_peak' => $this->queuedBytesPeak,
            'queued_bytes_limit' => $this->queuedBytesLimit,
